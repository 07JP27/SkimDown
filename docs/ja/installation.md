...
[Releases ページ](https://github.com/07JP27/SkimDown/releases) から新しい `.dmg` をダウンロードし、Applications フォルダ内の **SkimDown.app** を置き換えてください。Gatekeeper の警告が再び出る場合は `xattr -dr com.apple.quarantine /Applications/SkimDown.app` を再度実行してください。

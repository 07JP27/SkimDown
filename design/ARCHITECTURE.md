...
| `Settings` | Settingsウィンドウ UI（SwiftUI + NSHostingController） |
...
| `PreferencesWindowController` | Settingsウィンドウの表示管理（シングルトン） |
| `PreferencesView` | SwiftUI製のSettings UI（General/Themes/Editing タブ） |
